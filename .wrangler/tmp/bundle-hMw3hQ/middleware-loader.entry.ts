...
import {
	...
	__facade_invoke__,
	__facade_register__,
} from "/home/kasper/projects/middlecat-cloudflare/node_modules/wrangler/templates/middleware/common.ts";

import worker from "/home/kasper/projects/middlecat-cloudflare/.wrangler/tmp/bundle-hMw3hQ/middleware-insertion-facade.js";

// We need to preserve all of the exports from the worker
export * from "/home/kasper/projects/middlecat-cloudflare/.wrangler/tmp/bundle-hMw3hQ/middleware-insertion-facade.js";
