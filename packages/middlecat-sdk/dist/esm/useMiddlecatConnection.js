...
export default function useMiddlecatConnection(_a) {
    var _this = this;
    ...
    var signIn = useCallback(function (resource, middlecat_url) { return __awaiter(_this, void 0, void 0, function () {
        var r;
        return __generator(this, function (_a) {
            ...
            r = prepareURL(resource || fixedResource || "");
            if (!r)
                return [2 /*return*/];
            setLoading(true);
            return [2 /*return*/, authorize(r, middlecat_url)
    ...
    var signInGuest = useCallback(function (resource, middlecat_url) { return __awaiter(_this, void 0, void 0, function () {
        var r;
        return __generator(this, function (_a) {
            setError("");
            if (!resource && !fixedResource) {
    ...
    useEffect(function () {
        ...
        var resource = prepareURL(fixedResource || localStorage.getItem("resource") || "");
        if (!resource) {
            setLoading(false);
            return;
        }
...
function connectWithAuthGrant(resource, code, state, storeToken, bff, setUser, setLoading) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, authorizationCode(resource, code, state, bff)
                        .then(function (_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, axios.get("".concat(prepareURL(resource), "/config"), {
                            timeout: 5000,
                        })];
                case 2:
                    res = _b.sent();
                ...
                case 5:
                    _b.trys.push([5, 7, , 8]);
                    return [4 /*yield*/, refreshToken(middlecat, local_refresh_token || "", resource, bff)];
                case 6:
                    _a = _b.sent(), access_token = _a.access_token, refresh_token = _a.refresh_token;
                    if (access_token) {
                        user = createMiddlecatUser(access_token, refresh_token, storeToken, bff, resource || "", setUser);
                        setUser(user);
                        return [2 /*return*/, null];
                    }
                    return [3 /*break*/, 8];
